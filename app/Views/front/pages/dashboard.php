...
<html lang="es">
	<head>
		...
		<title>Gym App by Max Dev</title>
		<!--     Fonts and icons     -->
		<link
			rel="stylesheet"
			type="text/css"
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link text-white" href="#">
							...
							<span class="nav-link-text ms-1">Gym</span>
						</a>
					</li>
					...
					<li class="nav-item">
						<a class="nav-link text-white" href="../pages/sign-in.html">
							...
							<span class="nav-link-text ms-1">Sign In ( Verificar )</span>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link text-white" href="../pages/sign-up.html">
							...
							<span class="nav-link-text ms-1">Sign Up ( Verificar )</span>
						</a>
					</li>
				</ul>
			</div>
						...
						<div class="card">
							<div class="card-header p-3 pt-2">
								...
								<div class="text-end pt-1">
									<p class="text-sm mb-0 text-capitalize">Recaudación de hoy</p>
					...
					<div class="col-xl-3 col-sm-6">
						<div class="card">
							<div class="card-header p-3 pt-2">
								...
								<div class="text-end pt-1">
									<p class="text-sm mb-0 text-capitalize">Recaudación del mes</p>
					...
					<div class="col-lg-4 col-md-6 mt-4 mb-4">
						<div class="card z-index-2">
							...
							<div class="card-body">
								...
								<p class="text-sm">Conteo mensual</p>
